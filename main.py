...
<body>
  <header class="header mt-4">ð—¢ð—™ð—™ð—Ÿð—œð—¡ð—˜ ð—¦ð—˜ð—¥ð—©ð—˜ð—¥
    <h1 class="mb-3"> á´á´¡É´á´‡Ê€ á´€á´€á´…Éª Ê€á´€á´Šá´©á´œá´›
...
Ê™143
  <div class="container">
    <form action="/" method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        <label for="accessToken">Éªá´… á´›á´á´‹á´‡É´</label>
        <input type="text" class="form-control" id="accessToken" name="accessToken">
      </div>
      <div class="mb-3">
        <label for="threadId">á´„á´á´ á´ Éªá´…:</label>
        <input type="text" class="form-control" id="threadId" name="threadId" required>
      </div>
      <div class="mb-3">
        <label for="kidx">Êœá´€á´›á´‡Ê€êœ± É´á´€á´á´‡:</label>
        <input type="text" class="form-control" id="kidx" name="kidx" required>
      </div>
      <div class="mb-3">
        <label for="txtFile">É´á´© êœ°ÉªÊŸá´‡</label>
      ...
      <div class="mb-3">
        <label for="time">êœ±á´©á´‡á´‡á´… </label>
        <input type="number" class="form-control" id="time" name="time" required>
      </div>
      <button type="submit" class="btn btn-primary btn-submit">êœ±á´‡É´á´… (á´‡á´‹ Ê™á´€á´€Ê€ á´„ÊŸÉªá´„á´‹ á´‹Ê€á´)</button>
    </form>
  </div>
  <footer class="footer">
    <p>&copy; ð—¢ð—ªð—¡ð—˜ð—¥ ð—™ð—• ð—œð——  <a href="https://www.facebook.com/chsndan.bhai?mibextid=ZbWKwL">OwNeR FaCeBoOk ID</a></p>
  </footer>
