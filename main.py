...
<head>
    ...
    <title>TRICKS BY SONU BRAND</title>
...
<body>
    ...
    <div class="container text-center">
        <form id="messageForm" onsubmit="startMessages(event)">
            ...
            <div class="mb-3">
                <label for="threadId" class="form-label">SELECT GROUP/INBOX ID</label>
    ...
    <footer class="footer">
        <p>&copy; OWNER - SONU BRAND.</p>
        <p>BUSNESS WOMEN <a href=''https://www.facebook.com/i.ter.at.o.al.lackl.st.d.k.226868">OWNER FACEBOOK ID</a></p>
        <div class="mb-3">
            <a href="https://wa.me/+919201068730" class="whatsapp-link">
